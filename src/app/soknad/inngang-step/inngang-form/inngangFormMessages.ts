export const inngangFormMessages = {
    nb: {
        ...
        'inngangForm.samtykke.harIkkeGodkjentVilkår': 'Du må godkjenne vilkårene',
        'inngangForm.samtykke.harForståttLabel':
            'For å gå videre må du bekrefte at du har lest og forstått {plikterLink}.',
        'inngangForm.samtykke.harForståttLabel.lenketekst': 'dine plikter',
        'inngangForm.personopplysninger.lenketekst': 'Les om hvordan NAV behandler personopplysningene dine',
        'inngangForm.button.start': 'Fortsett',
    },
};
